...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 27 15:22:42 2018
...
#Define Agent class.
class Agent():
    def __init__ (self, environment,  agent_list, td_y, td_x):
        #Set the Agent list.
        ...
        #Set the Agent store.       
        self.store = 0
        #Set the start co-ordinates with the web data.
        self._y = td_y
        self._x = td_x
        if (td_x == None):
...
#Define the Wolf class and it's functions similarly to the Agent class.               
class Wolf():
    ...
    #Define '__str__' function which returns the x and y values for the agent.        
    def __str__ (self):
